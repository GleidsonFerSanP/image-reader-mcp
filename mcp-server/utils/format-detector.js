...
exports.detectFormatFromPath = detectFormatFromPath;
exports.mimeTypeToFormat = mimeTypeToFormat;
...
function detectFormatFromPath(filePath) {
    ...
    if (exports.SUPPORTED_FORMATS.includes(extension)) {
...
function isFormatSupported(format) {
    return exports.SUPPORTED_FORMATS.includes(format.toLowerCase());
}
